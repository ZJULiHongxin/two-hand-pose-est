...
idx_InterHand = [20,3,2,1,0,# right palm, thumb
                7,6,5,4, # index
                11,10,9,8, # middle
                15,14,13,12, # ring
                19,18,17,16, # pinky
                41,24,23,22,21, # left palm, thumb
                28,27,26,25, # index
                32,31,30,29, # middle
                36,35,34,33, # ring
                40,39,38,37] # pinky

# the area ratio covered by each joint region
part_ratio = [0.25, 0.17, 0.125, 0.12, 0.12,
                    0.15, 0.125, 0.12, 0.12,
                    0.15, 0.125, 0.12, 0.12,
                    0.15, 0.125, 0.12, 0.12,
                    0.12, 0.1, 0.1, 0.1]
# kinematic chain
