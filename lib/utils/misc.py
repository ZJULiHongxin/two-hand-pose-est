...
def plot_performance(PCK2d, th2d_lst, mse2d_each_joint, hand_type='right'):
    legend_lst = [
    # 0           1               2                  3                4
    ...
    if 'two' in hand_type.lower() or 'inter' in hand_type.lower():
        legend_lst = legend_lst[:-1] + legend_lst[:-1] + legend_lst[-1:]
