...
def transform_input_to_output_space(cfg, joint_coord, joint_valid, rel_root_depth, root_valid, root_joint_idx, joint_type):
    # transform to output heatmap space
    joint_coord = joint_coord.copy(); joint_valid = joint_valid.copy()
    
    orig_h, orig_w = cfg.DATASET.ORIGINAL_SIZE
    input_h, input_w = cfg.MODEL.IMAGE_SIZE
    joint_coord[:,0] = joint_coord[:,0] / orig_w * input_w
    joint_coord[:,1] = joint_coord[:,1] / orig_h * input_h
...
def process_bbox(bbox, input_img_shape):
